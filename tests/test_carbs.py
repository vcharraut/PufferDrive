...
class CARBSSearch:
    def __init__(self, experiment):
        ...
        param_spaces = [
            Param(name=str(i), space=LinearSpace(min=-10, max=10, is_integer=False), search_center=0.0)
...
class WandbSearch:
    def __init__(self, experiment, method="bayes", strategy=None):
        ...
        self.parameters = {f"param_{i}": {"distribution": "normal", "mu": 0, "sigma": 1} for i in range(10)}
